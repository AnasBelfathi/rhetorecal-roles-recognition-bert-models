#!/bin/bash
#SBATCH --job-name=legalbert_rr_ft              # nom du job
#SBATCH --output=./job_out_err/legalbert_rr_ft_%j.out          # nom du fichier de sortie
#SBATCH --error=./job_out_err/legalbert_rr_ft_%j.err           # nom du fichier d'erreur (ici en commun avec la sortie)
